...
namespace VideoGameDatabase.Models
{
    ...
    // this is a possibly redundant class for the game, because of issues with properties coming in as 'null'
    ...
    //    //    website = gfa.website;
    //    //    if (Int32.TryParse(gfa.rating, out int result))
    //    //    {
    //    //        rating = result;
    //    //    }
    //    //    else
